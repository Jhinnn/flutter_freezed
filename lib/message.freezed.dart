...
abstract class $MessageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String msgId, String content, int type, int? status});
}
...
class _$_Message with DiagnosticableTreeMixin implements _Message {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Message(msgId: $msgId, content: $content, type: $type, status: $status)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('msgId', msgId))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, msgId, content, type, status);
